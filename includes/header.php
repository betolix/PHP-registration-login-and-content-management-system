    <head>
        ...
        <!-- <link rel="stylesheet" href="/login_course/css/bootstrap.css">
        <link rel="stylesheet" href="/login_course/css/style.css">
        <script src="/login_course/resources/jquery.min.js"></script>  -->
